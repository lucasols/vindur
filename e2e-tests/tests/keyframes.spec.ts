...
test.describe("keyframes", () => {
  ...
  test("should handle complex keyframes with multiple stops", async ({ page }) => {
    ...
    await expect(slideIn).toHaveCSS("animation-timing-function", "cubic-bezier(0.68, -0.55, 0.265, 1.55)");
  });
});