...
describe('class generation', () => {
  test('should transform css styles', () => {
    ...
    const result = transform({ source, filePath: '/src/test.ts' });
...
describe('interpolation', () => {
  test('DEBUG: should resolve simple variables at compile time', () => {
    ...
    const result = transform({ source, filePath: '/src/debug.ts' });
  ...
  test('should handle variable interpolation in css styles', () => {
    ...
    const result = transform({ source, filePath: '/src/interpolation.ts' });
  ...
  test('should resolve valid variable references within the same file', () => {
    ...
    const result = transform({ source, filePath: '/src/variables.ts' });
  ...
  test('should throw error for complex expressions in interpolation', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/complex.ts' });
  ...
  test('should handle nested template literals', () => {
    ...
    const result = transform({ source, filePath: '/src/nested.ts' });
  ...
  test('should throw error for undefined variable references', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/undefined.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
...
describe('error handling', () => {
  test('should throw error for object property access', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/object.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
  ...
  test('should throw error for array access', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/array.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
  ...
  test('should throw error for function calls', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/function.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
      `[Error: unknown file: Invalid interpolation used at \`... style = css\` ... \${Math.max()}, only references to strings, numbers, or simple arithmetic calculations or simple string interpolations are supported]`,
    );
  });
  ...
  test('should throw error for conditional expressions', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/conditional.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
      `[Error: unknown file: Invalid interpolation used at \`... style = css\` ... \${condition ? value1 : value2}, only references to strings, numbers, or simple arithmetic calculations or simple string interpolations are supported]`,
    );
  });
  ...
  test('should throw error for logical expressions', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/logical.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
      `[Error: unknown file: Invalid interpolation used at \`... style = css\` ... \${condition ? value1 : value2}, only references to strings, numbers, or simple arithmetic calculations or simple string interpolations are supported]`,
    );
  });
  ...
  test('should throw error for unary expressions', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/unary.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
      `[Error: unknown file: Invalid interpolation used at \`... style = css\` ... \${condition ? value1 : value2}, only references to strings, numbers, or simple arithmetic calculations or simple string interpolations are supported]`,
    );
  });
  ...
  test('should throw error for array literals', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/array-literal.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
      `[Error: unknown file: Invalid interpolation used at \`... style = css\` ... \${obj[0]}, only references to strings, numbers, or simple arithmetic calculations or simple string interpolations are supported]`,
    );
  });
  ...
  test('should show actual variable name in error message', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/button.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
  ...
  test('should show direct usage in error message', () => {
    ...
    expect(() => {
      transform({ source, filePath: '/src/direct.ts' });
    }).toThrowErrorMatchingInlineSnapshot(
...
describe('corner cases', () => {
  test('should handle empty css templates', () => {
    ...
    const result = transform({ source, filePath: '/src/empty.ts' });
  ...
  test('should handle css with only whitespace', () => {
    ...
    const result = transform({ source, filePath: '/src/whitespace.ts' });
  ...
  test('should handle multiple css declarations in one file', () => {
    ...
    const result = transform({ source, filePath: '/src/multiple.ts' });
  ...
  test('should handle css with special characters and escapes', () => {
    ...
    const result = transform({ source, filePath: '/src/special.ts' });
  ...
  test('should resolve variables at different positions in CSS', () => {
    ...
    const result = transform({ source, filePath: '/src/positions.ts' });
  ...
  test('should handle invalid css syntax gracefully', () => {
    ...
    const result = transform({ source, filePath: '/src/invalid.ts' });
  ...
  test('should handle very long css content', () => {
    ...
    const result = transform({ source, filePath: '/src/long.ts' });
  ...
  test('should handle direct css usage without assignment', () => {
    ...
    const result = transform({ source, filePath: '/src/direct.ts' });
