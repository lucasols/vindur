...
describe('createDynamicCssColor', () => {
  ...
  describe('dynamic colors with spread props', () => {
    ...
    test('should handle dynamic color with spread props containing className', async () => {
      const source = dedent`
        import { createDynamicCssColor, styled } from 'vindur'
        ...
        const Component = () => {
          const propsWithClass = { 
            className: 'custom-container animated',
        ...
        const Component = () => {
          ...
          return (
            <div
              {...propsWithClass}
              {...color.setProps("#ff6b6b", {
                className: mergeClassNames([propsWithClass], "v1560qbr-2"),
              })}
              role="main"
            >
              Container content
    ...
    test('should handle dynamic color with spread props and additional className', async () => {
      const source = dedent`
        import { createDynamicCssColor, styled } from 'vindur'
