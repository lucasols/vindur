...
describe('createDynamicCssColor', () => {
  test('should throw error without hashId', () => {
    expect(() => createDynamicCssColor()).toThrowErrorMatchingInlineSnapshot(
      `[Error: createDynamicCssColor() cannot be called at runtime without compiler transformation. The ID is automatically generated by the compiler.]`,
    );
  });
...
describe('createClassName', () => {
  ...
  test('should throw error without id', () => {
    expect(() => createClassName()).toThrowErrorMatchingInlineSnapshot(
      `[Error: createClassName cannot be called at runtime]`,
    );
  });
});
