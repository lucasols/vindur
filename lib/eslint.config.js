...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      '@typescript-eslint/no-explicit-any': ERROR_IN_CI,
      '@typescript-eslint/no-unsafe-member-access': ERROR_IN_CI,
      '@typescript-eslint/no-unsafe-argument': ERROR_IN_CI,
      '@typescript-eslint/ban-ts-comment': ERROR_IN_CI,
      '@typescript-eslint/prefer-nullish-coalescing': ERROR_IN_CI,
      '@typescript-eslint/prefer-optional-chain': ERROR_IN_CI,
      '@typescript-eslint/no-non-null-assertion': ERROR_IN_CI,
      '@typescript-eslint/consistent-type-definitions': [ERROR_IN_CI, 'type'],
